'use strict';
var net = require('net'), Server = require('./server'), ltx = require('ltx'), StreamShaper = require('./stream_shaper'), IdleTimeout = require('./idle_timeout'), EventEmitter = require('events').EventEmitter, util = require('util');
var a = (function () {
    function a(b) {
    }
    ;
...
DomainContext.prototype.verifyIncoming = function (fromDomain, inStream, dbKey) {
    var self = this;
    var outStream = this.sendRaw(Server.dialbackVerify(this.domain, fromDomain, inStream.streamId, dbKey), fromDomain);
