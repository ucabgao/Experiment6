...
var partie = function () {
    ...
    */
    ...
    if (mouseDown && mouseMove && oTrait.iCompteurFaireClignoter == 0 && !oPolygone.bDisparitionPartie && !oTrait.bToucheEnnemi) {
        ...
        //
        oVecteurDirecteurTrait = new Point((oTrait.oPointArrivee.x - oTrait.oPointDepart.x) / (oTrait.oPointArrivee.x - oTrait.oPointDepart.x), (oTrait.oPointArrivee.y - oTrait.oPointDepart.y) / (oTrait.oPointArrivee.x - oTrait.oPointDepart.x));
        oPointArriveeVecteur = new Point(oVecteurDirecteurTrait.x + oTrait.oPointDepart.x, oVecteurDirecteurTrait.y + oTrait.oPointDepart.y);
        ...
        if (aListeEnnemis[0].fVitesse != 0 && bAugmenterOpacite) {
            for (var i = 0; i < aListeEnnemis.length; i++) {
                ...
                if (i == oTrait.iEnnemiTouche)
                    oTrait.oPositionEnnemiTouche = new Point((aListeEnnemis[i].oPosition.x + aListeEnnemis[i].oPosition.x + aListeEnnemis[i].iTailleX) / 2, (aListeEnnemis[i].oPosition.y + aListeEnnemis[i].oPosition.y + aListeEnnemis[i].iTailleY) / 2);
            }
        }
        else {
            ...
            if (bAugmenterOpacite) {
                ...
                ctx.arc(oTrait.oPositionEnnemiTouche.x, oTrait.oPositionEnnemiTouche.y, 200 * fGrandeurCercle, 0, 2 * Math.PI);
                ctx.fill();
                ctx.beginPath();
                ctx.lineWidth = 4;
                ...
                ctx.arc(oTrait.oPositionEnnemiTouche.x, oTrait.oPositionEnnemiTouche.y, (200 * fGrandeurCercle) + 4, 0, 2 * Math.PI);
                ctx.stroke();
                ctx.beginPath();
                ctx.lineWidth = 4;
                ctx.strokeStyle = "rgb(248,200,61)";
                ctx.arc(oTrait.oPositionEnnemiTouche.x, oTrait.oPositionEnnemiTouche.y, (200 * fGrandeurCercle) + 8, 0, 2 * Math.PI);
                ctx.stroke();
                ctx.beginPath();
                ctx.lineWidth = 4;
